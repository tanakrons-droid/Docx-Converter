...
export const disclaimerPolicy = {
    ...
    apply(html, $, options = {}) {
        ...
        return createWarningResult($.html(), [`เพิ่ม Disclaimer อัตโนมัติเนื่องจากพบคำ: ${foundKeywords.join(', ')}`], [`auto-inserted disclaimer for keywords: ${foundKeywords.join(', ')}`]);
    }
};
export default disclaimerPolicy;
//# sourceMappingURL=disclaimerPolicy.js.map