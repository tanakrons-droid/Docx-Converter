 ...
 */
export declare function createSuccessResult(html: string, actions?: string[]): PolicyResult;
/**
 * Helper to create a failed policy result
 */
export declare function createFailedResult(html: string, errors: string[], warnings?: string[]): PolicyResult;
/**
 * Helper to create a warning policy result
 */
export declare function createWarningResult(html: string, warnings: string[], actions?: string[]): PolicyResult;
